-- SQL script to directly create tables in Supabase SQL Editor
-- This is a simplified version that can be executed directly in the Supabase dashboard
...
-- Drop any columns we're trying to create to avoid errors
DO $$ 
BEGIN
    BEGIN
